...
public abstract class HeatConductionBlock<T extends HeatConductionBlockEntity<T>> extends EperBlockWithEntity<T> {
    public static final IntProperty TEMPERATURE = IntProperty.of("eper_temperature", 0 ,2);
