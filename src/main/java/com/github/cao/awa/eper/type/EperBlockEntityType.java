...
public class EperBlockEntityType<T extends BlockEntity> extends BlockEntityType<T> {
    private static final Logger LOGGER = LogUtils.getLogger();
    public static final BlockEntityType<PhotovoltaicPanelsBlockEntity> PHOTOVOLTAIC_PANELS = create("eper:photovoltaic_panels", Builder.create(PhotovoltaicPanelsBlockEntity::new, EperBlocks.PHOTOVOLTAIC_PANELS));
    public static final BlockEntityType<BurnerBlockEntity> BURNER = create("eper:burner", Builder.create(BurnerBlockEntity::new, EperBlocks.BURNER));
    ...
    public EperBlockEntityType(BlockEntityType.BlockEntityFactory<? extends T> factory, Set<Block> blocks, Type<?> type) {
    ...
    public record Builder<T extends BlockEntity>(
