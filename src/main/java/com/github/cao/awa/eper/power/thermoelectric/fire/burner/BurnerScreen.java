...
public class BurnerScreen extends HandledScreen<BurnerScreenHandler> {
    private static final Identifier TEXTURE = new Identifier("eper:textures/gui/container/burner.png");
    //    private static final Identifier TEXTURE = new Identifier("minecraft", "textures/gui/container/dispenser.png");

    public static void register() {
        HandledScreens.register(EperScreenHandlerType.BURNER, BurnerScreen::new);
    }
