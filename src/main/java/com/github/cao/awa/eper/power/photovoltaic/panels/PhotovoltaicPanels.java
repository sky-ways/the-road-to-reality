package com.github.cao.awa.eper.power.photovoltaic.panels;
...
// TODO waiting for Si
public class PhotovoltaicPanels extends EperBlockWithEntity<PhotovoltaicPanelsBlockEntity> {
    public static final Identifier IDENTIFIER = new Identifier("eper:photovoltaic_panels");
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return ! world.isClient && world.getDimension().hasSkyLight() ? checkType(type, EperBlockEntityType.PHOTOVOLTAIC_PANELS, this::tick) : null;
    }
    ...
    public BlockEntityType<PhotovoltaicPanelsBlockEntity> blockEntityType() {
        return EperBlockEntityType.PHOTOVOLTAIC_PANELS;
    }
}
