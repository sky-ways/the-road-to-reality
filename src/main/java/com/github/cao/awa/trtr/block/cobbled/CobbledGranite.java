...
public class CobbledGranite extends TrtrBlock {
    @Auto
    public static final Identifier IDENTIFIER = Identifier.tryParse("trtr:cobbled_granite");
    ...
    @Auto
    public CobbledGranite(Settings settings) {
        super(settings);
    }
}
