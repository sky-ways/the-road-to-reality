...
public class CrushedDeepslateCuprite extends TrtrItem implements Hammerable {
    public static final Identifier IDENTIFIER = new Identifier("trtr:crushed_deepslate_cuprite");
    ...
    public Set<Item> prototypes() {
        return Set.of(TrtrBlocks.DEEPSLATE_CUPRITE_BLOCk.asItem());
    }
}
