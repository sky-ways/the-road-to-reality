package com.github.cao.awa.trtr.block.pan.frying.model;

import com.github.cao.awa.apricot.anntation.Auto;
import com.github.cao.awa.apricot.anntation.Unsupported;
import com.github.cao.awa.trtr.block.TrtrBlocks;
import com.github.cao.awa.trtr.block.pan.frying.FryingPan;
...
@Auto
public class FryingPanModelProvider extends TrtrBlockModelProvider {
    @Auto
    public FryingPanModelProvider(FabricDataOutput output) {
        super(output);
    }

    @Override
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        Identifier identifier = FryingPan.IDENTIFIER;
    ...
    private MultipartBlockStateSupplier directions(MultipartBlockStateSupplier supplier) {
        DirectionProperty facing = FryingPan.FACING;
