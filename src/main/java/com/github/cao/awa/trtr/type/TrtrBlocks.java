...
public class TrtrBlocks {
    ...
    public static final Block ORTHOCLASE = new OrthoclaseBlock();

    public static final Block CHALCOPYRITE = new Chalcopyrite();
    public static final Block CUPRITE = new Cuprite();

    public static final Block WATER_VAPOR = WaterVapor.register();

    public static final Block GEAR_WHEEL = GearWheel.register();
