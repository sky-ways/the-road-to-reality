...
//    public static final EntityType<ElectricWire> ELECTRIC_WIRE;
    ...
    static {
//        ELECTRIC_WIRE = register("trtr:electric_wire", EntityType.Builder.create(ElectricWire::new, SpawnGroup.CREATURE).setDimensions(0.35F, 0.6F).maxTrackingRange(8).trackingTickInterval(2));
    }
}
