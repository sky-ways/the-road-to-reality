...
public class HashRangeFullCachedDatabase extends InstancePropertiesDatabase {
    ...
    public HashRangeFullCachedDatabase(String path) {
        ...
        for (int i = 0;;i++) {
            if (i > Integer.MAX_VALUE / PAGE_SIZE) {
                break;
            }
            load(i);
        }
