package com.github.cao.awa.trtr.ore.niter.crushed;
...
public class CrushedNiter extends TrtrItem implements Hammerable {
    public static final Identifier IDENTIFIER = new Identifier("trtr:crushed_niter");
