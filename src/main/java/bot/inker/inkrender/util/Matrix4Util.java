...
public final class Matrix4Util {
    ...
    public static void readRowMajor(Matrix4f matrix, FloatBuffer buf) {
        matrix.m00(buf.get(pack(0, 0)));
        matrix.m01(buf.get(pack(1, 0)));
        matrix.m02(buf.get(pack(2, 0)));
        matrix.m03(buf.get(pack(3, 0)));
        matrix.m10(buf.get(pack(0, 1)));
        matrix.m11(buf.get(pack(1, 1)));
        matrix.m12(buf.get(pack(2, 1)));
        matrix.m13(buf.get(pack(3, 1)));
        matrix.m20(buf.get(pack(0, 2)));
        matrix.m21(buf.get(pack(1, 2)));
        matrix.m22(buf.get(pack(2, 2)));
        matrix.m23(buf.get(pack(3, 2)));
        matrix.m30(buf.get(pack(0, 3)));
        matrix.m31(buf.get(pack(1, 3)));
        matrix.m32(buf.get(pack(2, 3)));
        matrix.m33(buf.get(pack(3, 3)));
    }
